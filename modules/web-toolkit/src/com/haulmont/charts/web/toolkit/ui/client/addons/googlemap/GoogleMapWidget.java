...
package com.haulmont.charts.web.toolkit.ui.client.addons.googlemap;
...
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.DrawingOptions;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.*;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.centerchange.CircleCenterChangeListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.click.CircleClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.click.MapClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.click.MarkerClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.click.PolygonClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.doubleclick.CircleDoubleClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.doubleclick.MarkerDoubleClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.overlaycomplete.CircleCompleteListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.overlaycomplete.PolygonCompleteListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.radiuschange.CircleRadiusChangeListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.rightclick.CircleRightClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.rightclick.MapRightClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.rightclick.MarkerRightClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.rightclick.PolygonRightClickListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.layers.GoogleMapHeatMapLayer;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.layers.GoogleMapKmlLayer;
...
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.services.DirectionsRequest;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.DirectionsResultHandler;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.MapTypeChangeListener;
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.overlays.GoogleMapLabelOptions;

import java.util.*;

import static com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.events.PolygonEditListener.ActionType.*;
...
public class GoogleMapWidget extends FlowPanel implements RequiresResize {
    ...
    private MarkerImage createMarkerImage(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.base.MarkerImage googleMapMarkerImage) {
    ...
    private Point createPoint(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.base.Point googleMapPoint) {
    ...
    private Size createSize(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.base.Size googleMapSize) {
    ...
    private native void addPolygonVertexClickListener(Polygon polygon) /*-{
        ...
        $wnd.google.maps.event.addListener(polygon, 'rightclick', function(e) {
            var removingEnabled = that.@com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.GoogleMapWidget::isVertexRemovingEnabled()();
            if (!removingEnabled) {
                return;
            }

            if (e.vertex != undefined) {
                var map = that.@com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.GoogleMapWidget::getMapImpl()();
    ...
    private native void initDeleteVertexOverlay() /*-{
        ...
        $wnd.DeleteVertexOverlay.prototype.open = function(map, polygon, vertex) {
            ...
            var deleteMessage = that.@com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.GoogleMapWidget::getRemoveMessage()();
    ...
    public void setDrawingOptions(DrawingOptions vOptions) {
        ...
        final com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.PolygonOptions vPolygonOptions = vOptions.getPolygonOptions();
        options.setPolygonOptions(GoogleMapAdapterUtils.toPolygonOptions(vPolygonOptions));

        final com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.CircleOptions vCircleOptions = vOptions.getCircleOptions();
    ...
    protected native void initLabelOverlay() /*-{
        ...
        $wnd.LabelOverlay.prototype.onAdd = function() {
            ...
            var primaryStylename = @com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.overlays.GoogleMapLabel::getPrimaryStylename()();
    ...
    protected native JavaScriptObject addLabel(GoogleMapLabelOptions labelOptions)/*-{
        var map = this.@com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.GoogleMapWidget::getMapImpl()();
    ...
    private class PolygonCompleteMapHandler implements
        ...
        private final com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.PolygonOptions polygonOptions;

        public PolygonCompleteMapHandler(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.PolygonOptions polygonOptions) {
    ...
    private class CircleCompleteMapHandler implements
        ...
        private final com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.CircleOptions circleOptions;

        public CircleCompleteMapHandler(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.CircleOptions circleOptions) {
