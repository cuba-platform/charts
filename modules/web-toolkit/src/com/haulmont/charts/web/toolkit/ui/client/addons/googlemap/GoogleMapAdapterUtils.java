...
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.services.*;
...
import com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.OverlayType;
...
public class GoogleMapAdapterUtils {
    ...
    public static PolygonOptions toPolygonOptions(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.PolygonOptions vOptions) {
    ...
    public static CircleOptions toCircleOptions(com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.CircleOptions vOptions) {
    ...
    public static ControlPosition toControlPosition(
            com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.drawing.ControlPosition vPosition) {
        if (vPosition == null) {
            return null;
        }
    ...
    public static ImageMapType toImageMapType(final GoogleImageMapType googleImageMapType) {
        ...
        if (googleImageMapType.getTileSize() != null) {
            com.haulmont.charts.web.toolkit.ui.client.addons.googlemap.base.Size googleSize = googleImageMapType.getTileSize();
