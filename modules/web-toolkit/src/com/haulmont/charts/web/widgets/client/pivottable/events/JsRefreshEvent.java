...
public class JsRefreshEvent extends JavaScriptObject {
    ...
    public final native String getRenderer() /*-{
        ...
        return @com.haulmont.charts.web.widgets.client.utils.JsUtils::getKeyByValue(*)(localeMapping, this.rendererName);
    }-*/;
    ...
    public final native String getAggregation() /*-{
        ...
        if (this.aggregatorsIds) {
            ...
            return @com.haulmont.charts.web.widgets.client.utils.JsUtils::getKeyByValue(*)(localeMapping, this.aggregatorName);
        }
    }-*/;
