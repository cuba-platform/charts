    ...
    protected void loadValueAxes(T chart, Element element) {
        ...
        if (valueAxesElement != null) {
            for (Object axisItem : valueAxesElement.elements("axis")) {
                ...
                String baseValue = axisElement.attributeValue("baseValue");
                if (StringUtils.isNotEmpty(baseValue)) {
                    axis.setBaseValue(Double.valueOf(baseValue));
                }

                String duration = axisElement.attributeValue("duration");
                ...
                String synchronizeWith = axisElement.attributeValue("synchronizeWith");
                if (StringUtils.isNotEmpty(synchronizeWith)) {
                    axis.setSynchronizeWith(synchronizeWith);
                }

                String totalText = axisElement.elementText("totalText");
                ...
                String useScientificNotation = axisElement.attributeValue("useScientificNotation");
